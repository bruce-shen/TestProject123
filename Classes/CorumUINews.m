...
@implementation CorumUINews
@synthesize fetchedResultsController=fetchedResultsController_, managedObjectContext=managedObjectContext_;
@synthesize tableView=tableView_;


- (id)init {
    if ((self = [super initWithNibName:@"CorumUINews" bundle:nil])) {
...
- (void)viewDidLoad
{
	...
	fetcher.fetchedResultsController = [self fetchedResultsController];
	[fetcher fetchNewBlogs];
	//
	//set up Title
	//
	self.title = @"News";
...
- (UITableViewCell *)tableView:(UITableView *)atableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (cell == nil) {
		...
		topLabel = [[UILabel alloc] initWithFrame:CGRectMake(20, 10, 250, 20)] ;
		...
		//
		bottomLabel =
		[[UILabel alloc] initWithFrame:CGRectMake(20,30,250,20)] ;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	NewsObject *selectedObject = (NewsObject*) [[self fetchedResultsController] objectAtIndexPath:indexPath];
