...
@implementation CorumUIAbout
@synthesize fetchedResultsController=fetchedResultsController_, managedObjectContext=managedObjectContext_;
@synthesize tableView=tableView_;


- (id)init {
    if ((self = [super initWithNibName:@"CorumUIAbout" bundle:nil])) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	AboutObject *selectedObject = (AboutObject*) [[self fetchedResultsController] objectAtIndexPath:indexPath];
	CorumPureContent *pureContent = [[CorumPureContent alloc] initWithNibName:@"CorumPureContent" bundle:nil];
